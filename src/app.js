...
// ── Spanish date-name arrays + preset display names (Brief #44f, Clusters A/B) ─
// DORMANT: nothing reads these yet — #44g wires activeLocale into the date/label
// and type-picker plumbing. Display-only; storage/computation locale stays en-CA
// (todayStr) and tasks.name storage stays English (only the preset type-picker
// label is localized). Each *_BY_LOCALE map mirrors the TRANSLATIONS[activeLocale]
// shape, with `en` aliasing the English const above as the single source.
const WEEKDAY_NAMES_ES      = ['Do', 'Lu', 'Ma', 'Mi', 'Ju', 'Vi', 'Sá'];          // 2-letter (min)
const WEEKDAY_NAMES_ABBR_ES = ['Dom', 'Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb'];   // 3-letter
const MONTH_NAMES_ES = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio',
  'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'];
// Short months (fills taskSheet.recSummary.yearlyOn {month}); init-caps first-3
// per the doc's stated convention (Feb/Mar explicitly approved, rest derived).
const YEARLY_MONTH_SHORT_ES = ['Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun',
  'Jul', 'Ago', 'Sep', 'Oct', 'Nov', 'Dic'];
const WEEKDAY_NAMES_BY_LOCALE      = { en: WEEKDAY_NAMES,      es: WEEKDAY_NAMES_ES };
const WEEKDAY_NAMES_ABBR_BY_LOCALE = { en: WEEKDAY_NAMES_ABBR, es: WEEKDAY_NAMES_ABBR_ES };
const MONTH_NAMES_BY_LOCALE        = { en: MONTH_NAMES,        es: MONTH_NAMES_ES };
// Cluster B — preset display names by locale. Keys are the (English, unchanged)
// TASK_CONFIG storage keys; `en` derives from TASK_CONFIG.name, `es` is the
// approved Spanish label set (infinitive/noun forms, distinct from careVerb.*).
const TASK_CONFIG_NAMES_ES = {
  'normal-water': 'Riego',
...
const TASK_CONFIG_NAMES_BY_LOCALE = {
...
// #44f (Cluster A): dormant locale map for the short-month labels; es data +
// rationale are defined with the other Spanish date arrays near MONTH_NAMES_ES.
const YEARLY_MONTH_SHORT_BY_LOCALE = { en: YEARLY_MONTH_SHORT, es: YEARLY_MONTH_SHORT_ES };
